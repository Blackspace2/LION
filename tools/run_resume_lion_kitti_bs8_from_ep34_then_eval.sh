...
TRAIN_TAG="lion_mamba_kitti_single_gpu_bs8_fp16_resume_ep34_lr4e-4_clip2"
...
RESUME_CKPT="${RESUME_CKPT:-/root/autodl-tmp/LION_output/cfgs/kitti_models/second_with_lion_mamba_64dim/lion_mamba_kitti_single_gpu_bs10_fp16_resume_lr8e-4_clip3/ckpt/checkpoint_epoch_34.pth}"
