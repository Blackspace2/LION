...
TRAIN_TAG="lion_mamba_kitti_single_gpu_bs12_fp16_resume_lr1e-3_clip3"
...
RESUME_CKPT="${RESUME_CKPT:-/root/autodl-tmp/LION_output/cfgs/kitti_models/second_with_lion_mamba_64dim/lion_mamba_kitti_single_gpu_bs12_fp16_resume_lr1e-3_clip3/ckpt/checkpoint_epoch_24.pth}"
