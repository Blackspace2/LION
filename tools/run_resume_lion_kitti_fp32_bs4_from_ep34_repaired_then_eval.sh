...
TRAIN_TAG="lion_mamba_kitti_single_gpu_fp32_bs4_resume_ep34_bn_repaired_lr2e-4_clip2"
...
RESUME_CKPT="${RESUME_CKPT:-/root/autodl-tmp/LION_output/cfgs/kitti_models/second_with_lion_mamba_64dim/repaired_ckpt/checkpoint_epoch_34_bn_repaired_from_epoch26.pth}"
